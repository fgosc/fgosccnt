...
dist_item ={
    ...
    '宝玉':np.array([[86, 165, 195, 114, 185, 177, 137, 114]], dtype='uint8'),
...
##    '術猛火':np.array([[249,  54,  86,  57, 244,  43,  55,  74]], dtype='uint8'),
    '術猛火':np.array([[ 81, 221,  38,  59, 188,  86,  26, 141]], dtype='uint8'),
    '殺猛火':np.array([[ 81, 221,  38,  35,  60,  86,  26,  13]], dtype='uint8'),
...
# 同じレアリティの中での順番ルールは不明
std_item = ['カケラ', '卵', '鏡','炉心', '神酒', '胆石', '産毛', 'スカラベ',    
    'ランプ', '幼角', '根', '逆鱗', '心臓', '爪', '脂', '涙石' , 
    '冠', '矢尻', '鈴', 'オーロラ',  '指輪', '結氷', '勾玉','貝殻', '勲章', 
